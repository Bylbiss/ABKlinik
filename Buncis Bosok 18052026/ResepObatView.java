...
public class ResepObatView extends JPanel {
    ...
    private final Color PINK_COLOR = new Color(232, 62, 140);
    private final Color PINK_DARK = new Color(200, 40, 110);
    private final Color PINK_LIGHT = new Color(255, 230, 240);
    ...
    private void initComponents() {
        ...
        tabbedPane.setForeground(PINK_COLOR);
        ...
        btnRefreshPemesanan = createStyledButton("Refresh Daftar Pemesanan", PINK_COLOR);
        ...
        btnBuatResep = createStyledButton("Buat Resep untuk Pemesanan Terpilih", PINK_COLOR);
        ...
        btnDetailResep = createStyledButton("Detail Resep", PINK_COLOR);
...
private void styleTable(JTable table) {
        ...
        // Warna seleksi pink
        table.setSelectionBackground(new Color(232, 62, 140));
        table.setSelectionForeground(Color.WHITE);

        // Zebra stripe dan renderer kustom
        table.setDefaultRenderer(Object.class, new javax.swing.table.DefaultTableCellRenderer() {
            ...
            public java.awt.Component getTableCellRendererComponent(JTable table, Object value,
                ...
                if (!isSelected) {
                    // Baris genap: biru muda, baris ganjil: putih
                    if (row % 2 == 0) {
        ...
        // Header tabel (opsional, agar lebih rapi)
        table.getTableHeader().setBackground(new Color(232, 62, 140));
    ...
    private void detailResep() {
        ...
        spObat.setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createLineBorder(PINK_COLOR), "Daftar Obat yang Diresepkan",
                TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION,
                new Font("Arial", Font.BOLD, 12), PINK_COLOR));
        ...
        btnOK.setBackground(PINK_COLOR);
    ...
    private class BuatResepDialog extends JDialog {
        ...
        private void initComponents() {
            ...
            JButton searchBtn = createStyledButton("Cari", PINK_COLOR);
            ...
            spObat.setBorder(BorderFactory.createTitledBorder(
                    BorderFactory.createLineBorder(PINK_COLOR), "Pilih Obat",
                    TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION,
                    new Font("Arial", Font.BOLD, 12), PINK_COLOR));
            leftPanel.add(spObat, BorderLayout.CENTER);

            // Tombol tambah ke resep
            JButton btnTambah = createStyledButton(">> Tambah Obat ke Resep", PINK_COLOR);
            ...
            spDetail.setBorder(BorderFactory.createTitledBorder(
                    BorderFactory.createLineBorder(PINK_COLOR), "Detail Resep",
                    TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION,
                    new Font("Arial", Font.BOLD, 12), PINK_COLOR));
            ...
            JButton btnSimpan = createStyledButton("Simpan Resep", PINK_COLOR);
            ...
            infoPetPanel.setBorder(BorderFactory.createTitledBorder(
                    BorderFactory.createLineBorder(PINK_COLOR), "Informasi Hewan & Alergi",
                    TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION,
                    new Font("Arial", Font.BOLD, 12), PINK_COLOR));
