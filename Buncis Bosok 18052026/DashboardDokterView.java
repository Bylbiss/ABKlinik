...
public class DashboardDokterView extends JFrame {
    ...
    private final Color PINK_MAIN = new Color(232, 62, 140); 
    private final Color PINK_DARK = new Color(200, 40, 110);
    private final Color PINK_LIGHT = new Color(255, 220, 240);
    ...
    private void initComponents() {
        ...
        headerPanel.setBackground(PINK_MAIN);
        ...
        sidebar.setBackground(PINK_LIGHT);
    ...
    private void editProfilDokter() {
        ...
        btnSimpan.setBackground(PINK_MAIN);
    ...
    private JPanel createProfilPanel() {
        ...
        editBtn.setBackground(PINK_MAIN);
