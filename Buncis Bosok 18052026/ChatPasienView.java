...
public class ChatPasienView extends JPanel {
    ...
    private final Color LIGHT_PINK = new Color(255, 220, 240);
    ...
    private void initComponents() {
        ...
        leftPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(PINK_COLOR), "Pasien yang pernah chat", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font("Arial", Font.BOLD, 12), PINK_COLOR));
        ...
        rightPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(PINK_COLOR), "Percakapan", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font("Arial", Font.BOLD, 12), PINK_COLOR));
        ...
        sendButton.setBackground(PINK_COLOR);
    ...
    private void addMessageBubble(String message, Timestamp waktu, boolean isFromDokter) {
        ...
        Color bgColor = isFromDokter ? new Color(240, 240, 240) : new Color(240, 240, 240);
        int radius = 15;
