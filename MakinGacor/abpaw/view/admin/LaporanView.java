...
public class LaporanView extends JPanel {
    ...
    private void initComponents() {
        ...
        cbJenisLaporan = new JComboBox<>(new String[]{"Pemesanan Online", "Pemesanan Offline", 
            "Semua Transaksi", "Pendapatan per Dokter", "Penjualan Obat"});
    ...
    private void displayPendapatanPerDokterWithNames(List<Object[]> data) {
        ...
        for (Object[] row : data) {
            model.addRow(new Object[]{
                ...
                row[1],  // nama dokter
                row[2],  // jml online
                "Rp " + row[3],  // pendapatan online
                row[4],  // jml offline
                "Rp " + row[5],  // pendapatan offline
                "Rp " + row[6]   // total
            });
        }
    }
    ...
    private void displayPenjualanObat(List<Object[]> list) {
        String[] cols = {"Kode Transaksi", "Nama Obat", "Jumlah", "Total", "Tanggal", "Pemilik"};
        model.setDataVector(new Object[0][0], cols);
        for (Object[] row : list) {
            model.addRow(new Object[]{
                row[0], row[1], row[2], "Rp " + row[3], row[4], row[5]
            });
        }
    }
