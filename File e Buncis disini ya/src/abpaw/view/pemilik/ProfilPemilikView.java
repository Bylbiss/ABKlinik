...
public class ProfilPemilikView extends JPanel {
    ...
    // Tab Profil
    private JTextField txtNamaLengkap, txtEmail, txtNoHp, txtAlamat;
    ...
    private void simpanProfil() {
        ...
        if (nama.isEmpty() || email.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Nama dan Email wajib diisi!", "Peringatan", JOptionPane.WARNING_MESSAGE);
            return;
        }
    ...
    // Method tambahan pada PetsController (jika belum ada)
    // Harus ditambahkan di PetsController.java:
    // public Pets getPetsById(int id) { return petsDAO.getById(id); }
    // public boolean updatePets(Pets pet) { return petsDAO.update(pet); }
    // public boolean deletePets(int id) { return petsDAO.delete(id); }
}