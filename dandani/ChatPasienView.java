...
public class ChatPasienView extends JPanel {
    ...
    private void initComponents() {
        ...
        rightPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(GREEN_COLOR), "Percakapan", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font("Arial", Font.BOLD, 12), GREEN_COLOR));
    ...
    private boolean isPemesananAktif(int idPemilik) {
        ...
        for (PemesananOffline poff : offlineList) {
            if (poff.getIdPemilik() == idPemilik) {
