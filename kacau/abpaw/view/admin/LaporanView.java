...
public class LaporanView extends JPanel {
    ...
    private void displayPenjualanObat(List<Object[]> list) {
        ...
        BigDecimal hargaSatuan = totalHarga.divide(BigDecimal.valueOf(jumlah), 2, RoundingMode.HALF_UP);
            ...
            model.addRow(new Object[]{
                row[0],  // kode transaksi
                row[1],  // nama obat
                row[2],  // jumlah
                "Rp " + hargaSatuan,  // harga satuan
                "Rp " + totalHarga,   // total
                row[4],  // tanggal
                row[5]   // pemilik
            });
    ...
    private void styleTable() {
        ...
        Color lightPink = new Color(255, 220, 240);
        
        // Header tabel
        table.getTableHeader().setBackground(pinkColor);
        ...
        table.setSelectionBackground(pinkColor);
