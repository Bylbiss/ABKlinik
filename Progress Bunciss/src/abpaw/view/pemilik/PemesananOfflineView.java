...
public class PemesananOfflineView extends JPanel {
    ...
    private JPanel createFormPanel() {
        ...
        gbc.gridy++;
        gbc.gridx = 0;
        form.add(new JLabel("Pilih Kupon:"), gbc);
        ...
        cbKupon.addActionListener(e -> hitungBiaya());
        gbc.gridx = 1;
        form.add(cbKupon, gbc);
        ...
        gbc.gridx = 1;
        form.add(lblDiskon, gbc);
        
        gbc.gridy++;
        gbc.gridx = 0;
        form.add(new JLabel("Total Biaya:"), gbc);
    ...
    private JPanel createDokterCard(Dokter dokter) {
        ...
        pilihBtn.addActionListener(e -> {
            ...
            hitungBiaya(); // update diskon dan total
    ...
    private void hitungBiaya() {
        ...
        if (selected != null && selected.isValid() && biayaAwal.compareTo(selected.getMinimalPembelian()) >= 0) {
            diskon = selected.hitungPotongan(biayaAwal);
        } else {
            ...
            if (selected != null && biayaAwal.compareTo(selected.getMinimalPembelian()) < 0) {
                JOptionPane.showMessageDialog(this,
                    ...
                    "Kupon Tidak Berlaku", JOptionPane.WARNING_MESSAGE);
    ...
    private void prosesBooking() {
        ...
        if (success) {
            ...
            new StrukView(parent, antrean, biayaAwal, diskon, total);
        } else {
