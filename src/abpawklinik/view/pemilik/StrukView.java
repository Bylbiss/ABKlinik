 ...
 */
package abpawklinik.view.pemilik;
...
public class StrukView extends JDialog {
    ...
    private String getNamaPemilik(int idPemilik) {
        try {
            abpawklinik.model.dao.PemilikDAO dao = new abpawklinik.model.dao.PemilikDAO();
            abpawklinik.model.entity.Pemilik p = dao.getById(idPemilik);
    ...
    private String getNamaDokter(int idDokter) {
        try {
            abpawklinik.model.dao.DokterDAO dao = new abpawklinik.model.dao.DokterDAO();
            abpawklinik.model.entity.Dokter d = dao.getById(idDokter);
    ...
    private String getNamaPet(int idPet) {
        try {
            abpawklinik.model.dao.PetsDAO dao = new abpawklinik.model.dao.PetsDAO();
            abpawklinik.model.entity.Pets p = dao.getById(idPet);
    ...
    private void initComponentsForOffline(PemesananOffline poff) {
        ...
        abpawklinik.controller.PemesananController pc = new abpawklinik.controller.PemesananController();
        java.util.List<abpawklinik.model.entity.DetailBiayaOffline> daftarBiaya = pc.getBiayaTambahan(poff.getIdTransaksi());
        ...
        if (!daftarBiaya.isEmpty()) {
            ...
            for (abpawklinik.model.entity.DetailBiayaOffline d : daftarBiaya) {
