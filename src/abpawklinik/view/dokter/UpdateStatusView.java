 ...
 */
package abpawklinik.view.dokter;

import abpawklinik.controller.PemesananController;
import abpawklinik.controller.PemilikController;
import abpawklinik.model.entity.*;
import abpawklinik.model.entity.DetailBiayaOffline;
import javax.swing.*;
...
public class UpdateStatusView extends JPanel {
    ...
    private void initComponents() {
        ...
        gbcInput.insets = new Insets(5, 8, 5, 8);
        ...
        JLabel lblNamaBiaya = new JLabel("Nama Biaya:");
        lblNamaBiaya.setFont(new Font("Arial", Font.BOLD, 12));
        inputPanel.add(lblNamaBiaya, gbcInput);

        gbcInput.gridx = 1;
        gbcInput.gridy = 0;
        gbcInput.gridwidth = 3;
        txtNamaBiaya = new JTextField();
        txtNamaBiaya.setPreferredSize(new Dimension(250, 32));
        txtNamaBiaya.setFont(new Font("Arial", Font.PLAIN, 12));
        inputPanel.add(txtNamaBiaya, gbcInput);

        // Baris 2: Jumlah dan Harga
        gbcInput.gridx = 0;
        gbcInput.gridy = 1;
        gbcInput.gridwidth = 1;
        JLabel lblJumlah = new JLabel("Jumlah:");
        lblJumlah.setFont(new Font("Arial", Font.BOLD, 12));
        inputPanel.add(lblJumlah, gbcInput);

        gbcInput.gridx = 1;
        gbcInput.gridy = 1;
        gbcInput.gridwidth = 1;
        txtJumlah = new JTextField("1");
        txtJumlah.setPreferredSize(new Dimension(80, 32));
        txtJumlah.setFont(new Font("Arial", Font.PLAIN, 12));
        txtJumlah.setHorizontalAlignment(JTextField.CENTER);
        inputPanel.add(txtJumlah, gbcInput);
        ...
        inputPanel.add(lblHarga, gbcInput);

        gbcInput.gridx = 3;
        gbcInput.gridy = 1;
        gbcInput.gridwidth = 1;
        txtHargaSatuan = new JTextField();
        txtHargaSatuan.setPreferredSize(new Dimension(150, 32));
        txtHargaSatuan.setFont(new Font("Arial", Font.PLAIN, 12));
        inputPanel.add(txtHargaSatuan, gbcInput);
        ...
        btnTambahBiaya.setFont(new Font("Arial", Font.BOLD, 12));
        btnTambahBiaya.setFocusPainted(false);
        btnTambahBiaya.setCursor(new Cursor(Cursor.HAND_CURSOR));
        btnTambahBiaya.setPreferredSize(new Dimension(140, 38));
        ...
        btnHapusBiaya.setFont(new Font("Arial", Font.BOLD, 12));
        btnHapusBiaya.setFocusPainted(false);
        btnHapusBiaya.setCursor(new Cursor(Cursor.HAND_CURSOR));
        btnHapusBiaya.setPreferredSize(new Dimension(170, 38));

        btnTambahBiaya.addActionListener(e -> tambahBiayaTambahan());
        btnHapusBiaya.addActionListener(e -> hapusBiayaTambahan());

        tombolPanel.add(btnTambahBiaya);
        tombolPanel.add(btnHapusBiaya);

        gbcInput.gridx = 0;
        gbcInput.gridy = 2;
        gbcInput.gridwidth = 4;
        gbcInput.anchor = GridBagConstraints.CENTER;
        inputPanel.add(tombolPanel, gbcInput);
