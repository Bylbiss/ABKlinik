...
public class ManageDokterView extends JPanel {
    ...
    private void initComponents() {
        ...
        styleButton(btnTambah, PINK_COLOR);
        styleButton(btnEdit, PINK_COLOR);
    ...
    private class DokterFormDialog extends JDialog {
        ...
        private void initComponents() {
            ...
            styleButton(btnSave, PINK_COLOR);
    ...
    private void styleTable() {
        table.getTableHeader().setBackground(PINK_COLOR);
        ...
        table.setSelectionBackground(PINK_COLOR);
        ...
        table.setDefaultRenderer(Object.class, new javax.swing.table.DefaultTableCellRenderer() {
            ...
            public java.awt.Component getTableCellRendererComponent(JTable table, Object value,
                ...
                if (hasFocus && !isSelected) {
                    if (row % 2 == 0) {
                        c.setBackground(new Color(255, 220, 235));
                    } else {
