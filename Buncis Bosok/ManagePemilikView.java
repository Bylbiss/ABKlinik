...
public class ManagePemilikView extends JPanel {
    ...
    private static final Color PINK_MAIN = new Color(232, 62, 140); 
    private static final Color PINK_LIGHT = new Color(255, 220, 235); 
    private static final Color PINK_DARK = new Color(200, 40, 110);
    ...
    private class PemilikFormDialog extends JDialog {
        ...
        table.getTableHeader().setBackground(PINK_MAIN);
        ...
        table.setSelectionBackground(PINK_MAIN);
