...
public class DashboardAdminView extends JFrame {
    ...
    private void initComponents() {
        ...
        headerPanel.setBackground(new Color(232, 62, 140));
    ...
    private JPanel createWelcomePanel() {
        ...
        welcomeLabel.setForeground(new Color(232, 62, 140));
    ...
    private JButton createSidebarButton(String text, boolean isBold) {
        ...
        btn.setBackground(new Color(232, 62, 140));
        ...
        btn.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent evt) {
                btn.setBackground(new Color(200, 40, 110));
                btn.setForeground(Color.WHITE); 
            }
    ...
    private JButton createSubMenuButton(String text) {
        ...
        btn.setForeground(new Color(232, 62, 140)); 
        btn.setFocusPainted(false);
        ...
        btn.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent evt) {
                ...
                btn.setForeground(new Color(200, 40, 110));
            }
            public void mouseExited(MouseEvent evt) {
                btn.setBackground(new Color(240, 248, 255));
                btn.setForeground(new Color(232, 62, 140)); 
