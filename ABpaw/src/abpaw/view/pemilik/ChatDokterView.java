...
public class ChatDokterView extends JPanel {
    ...
    public ChatDokterView(User pemilik) {
    ...
    private void loadDokter() {
        ...
        if (filter.equals("Harga Termurah")) {
            ...
            // Akan diimplementasikan nanti dengan hewan milik user
        }
    ...
    private JPanel createDokterCard(Dokter dokter) {
        ...
        pilihBtn.addActionListener(e -> {
            ...
            if (option == 0 || option == 1) {
                ...
                // Buka frame pembayaran atau langsung chat (belum diimplementasikan)
                JOptionPane.showMessageDialog(parent, "Fitur pembayaran akan segera hadir.\nDokter: " + dokter.getNamaLengkap());
                // Jika langsung, buka chat; jika nanti, simpan ke riwayat.
                // Untuk demo, kita buka chat langsung
                if (langsung) {
