...
public class ChatDokterView extends JPanel {
    ...
    private void loadDokter() {
        ...
        // 1. Ambil dokter berdasarkan spesialisasi
            ...
            if (!jenisHewanSaya.isEmpty()) {
                filteredDokter = filteredDokter.stream()
                        .filter(dokter -> {
                            ...
                            if (spesies == null || spesies.trim().isEmpty()) return false;
                ...
                filteredDokter.clear(); // tidak ada hewan
            }
        }

        // 4. Urutkan berdasarkan harga (Murah ke Mahal / Mahal ke Murah)
